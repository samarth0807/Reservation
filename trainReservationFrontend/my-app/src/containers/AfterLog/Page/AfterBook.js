  ...
  render() {
    ...
    if(trainsList.length==0){
      return (
        <div>
        <Navbar/>
        <header style={{backgroundImage:`url(${"https://images.pexels.com/photos/34950/pexels-photo.jpg?auto=compress&cs=tinysrgb&dpr=1&w=500"})`,height:'1000px',backgroundSize:'cover',display: 'block'}}><h1 style={{padding:'100px',textAlign:'center',fontSize:'xxx-large',fontFamily:'ui-rounded',color:'red'}}>Book Train Tickets</h1>
      ...
      return (
        ...
        <Segment style={{height:'100%'}}>
          {trainsList.map((train)=>{
            return <div key={train.number} style={{backgroundImage:`url('https://images.pexels.com/photos/34950/pexels-photo.jpg?auto=compress&cs=tinysrgb&dpr=1&w=500')`,backgroundColor:'gray',marginTop:'0.6em',marginBottom:'0.6em',marginLeft:'0.4em',marginRight:'0.4em'}}>
